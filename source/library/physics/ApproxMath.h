/*
    This source file is originally part of Rigs of Rods
...
/// Added to SoftBodyLib
/// @author Jonathan Rurka
...
inline glm::vec3 approx_normalise(glm::vec3 v)
{
    return v*approx_invSqrt(glm::length2(v));
}

inline glm::vec3 fast_normalise(glm::vec3 v)
{
    return v*fast_invSqrt(glm::length2(v));
}

inline float approx_length(glm::vec3 v)
{
    return approx_sqrt(glm::length2(v));
}

inline float fast_length(glm::vec3 v)
{
    return fast_sqrt(glm::length2(v));
}
